      ...
      <ul className="faq__list">
        <li className="faq__item">
          ...
          <p className="faq__item-text">
            ...
            Maecenas id neque ipsum. Cras ut felis ultrices enim faucibus congue
            sit amet id ipsum. Pellentesque id dapibus ex, a blandit erat. Sed
            tincidunt lorem sit amet ullamcorper congue.
          </p>
        </li>
        <li className="faq__item">
